  ...
  <div>
    <div v-if="!isTypeChosen" class="host-home card">
      ...
      <div class="card-body home-text">
        <h5 class="card-title">Hello Quizmaster! + Oval</h5>
        <p class="card-text">
        ...
        <template v-if="!isSmallWidth">
          <button class="btn" id="btn-1" type="submit" @click="setQuizType('CustomQuiz')">
      ...
      <div class="card-footer text-muted footer-black">
        <a href="https://github.com/Srushtika/realtime-quiz-framework" target="_blank" class="link">Learn how to build
